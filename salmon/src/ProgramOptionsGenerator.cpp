...
namespace salmon {
  ...
  po::options_description ProgramOptionsGenerator::getAlevinBasicOptions(SalmonOpts& sopt) {
    ...
    alevinspec.add_options()
      ...
      (
       "regularization_parameter",po::value<double>()->default_value(alevin::defaults::regularization_parameter),
       "define the intensity of regularization.")
      (
       "rare_gene_cut_off",po::value<double>()->default_value(alevin::defaults::rare_gene_cut_off),
       "define the cut off of rare gene exclusion.")
      (
